...
/* Fichier contenant toutes les fonctions de test 
   pour chacune des fonctions defini dans biblio.h,
   il est unique pour les 4 structures.
   
   Rq: fichier un peu sale, peu organise, peu commente */

#include "jeu_test.h"

// tableau contenant des numeros de morceau entre 0 et 300600 genere aleatoirement
...
/*Fonction qui genere aleatoirement un tableau de taille taille_tab avec des valeur entre 0 et nbMorceau */
